...
* release versioning: Drop the release type property from the DB [Thodoris Greasidis]
...
* release versioning: Read only the new fields but keep setting both [Thodoris Greasidis]
* Add release semver & revision uniqueness rule [Thodoris Greasidis]

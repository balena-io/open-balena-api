...
export const LOKI_HISTORY_TIMEOUT = intVar('LOKI_HISTORY_TIMEOUT', 55000);
...
export const ASYNC_TASK_DELETE_REGISTRY_IMAGES_CONCURRENCY = intVar(
	'ASYNC_TASK_DELETE_REGISTRY_IMAGES_CONCURRENCY',
	10,
);
export const ASYNC_TASK_DELETE_REGISTRY_IMAGES_OFFSET_MS = intVar(
	'ASYNC_TASK_DELETE_REGISTRY_IMAGES_OFFSET_MS',
	30 * DAYS, // 30 days in milliseconds
);
export let ASYNC_TASK_DELETE_REGISTRY_IMAGES_MAX_TIME_MS = intVar(
...
export const REGISTRY_STORAGE_BUCKET = optionalVar('REGISTRY_STORAGE_BUCKET');
export const REGISTRY_STORAGE_ROOT_PATH = optionalVar(
...
export const REGISTRY_STORAGE_SECRET_KEY = optionalVar(
	'REGISTRY_STORAGE_SECRET_KEY',
);
export const REGISTRY_STORAGE_FORCE_PATH_STYLE = boolVar(
...
export const DEVICE_LOGS_LOKI_CONTEXT_CACHE_TIMEOUT = intVar(
...
export const WEBRESOURCES_S3_STORAGE_CLASS = optionalVar(
...
export const TEST_MOCK_ONLY = {
	...
	set ASYNC_TASK_DELETE_REGISTRY_IMAGES_MAX_TIME_MS(
		v: typeof ASYNC_TASK_DELETE_REGISTRY_IMAGES_MAX_TIME_MS,
	) {
		guardTestMockOnly();
		ASYNC_TASK_DELETE_REGISTRY_IMAGES_MAX_TIME_MS = v;
	},
};

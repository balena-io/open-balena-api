...
export const DEVICE_CONFIG_SSH_AUTHORIZED_KEYS_EMPTY_OVERRIDE = boolVar(
...
export let ASYNC_TASK_DELETE_REGISTRY_IMAGES_OFFSET_MS = intVar(
	'ASYNC_TASK_DELETE_REGISTRY_IMAGES_OFFSET_MS',
	30 * DAYS, // 30 days in milliseconds
);
export const REGISTRY_REQUEST_DELAY = intVar('REGISTRY_REQUEST_DELAY', 500);
...
export const TEST_MOCK_ONLY = {
	...
	set ASYNC_TASK_DELETE_REGISTRY_IMAGES_OFFSET_MS(
		v: typeof ASYNC_TASK_DELETE_REGISTRY_IMAGES_OFFSET_MS,
	) {
		guardTestMockOnly();
		ASYNC_TASK_DELETE_REGISTRY_IMAGES_OFFSET_MS = v;
	},
};
